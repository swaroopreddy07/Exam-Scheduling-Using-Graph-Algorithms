...
int main() {
    ...
    // Call DSATURScheduling() for each graph representation with timing
    
    cout << "/**************************** >DSATURScheduling ****************************" << endl;
    cout << "*********************************** EDGELIST ************************************* " << endl;
    auto start = chrono::high_resolution_clock::now();
    G1->DSATURScheduling(numSubjectsInput, subjects);
    auto end = chrono::high_resolution_clock::now();
    auto duration = chrono::duration_cast<chrono::milliseconds>(end - start).count();
    cout << "Time taken by DSATURScheduling for EdgeList: " << duration << " ms" << endl;
    cout << "/*********************************************************/" << endl;

    cout << "/**************************** >DSATURScheduling ****************************" << endl;
    cout << "************************************ ADJLIST *************************************** " << endl;
    start = chrono::high_resolution_clock::now();
    G2->DSATURScheduling(numSubjectsInput, subjects);
    end = chrono::high_resolution_clock::now();
    duration = chrono::duration_cast<chrono::milliseconds>(end - start).count();
    cout << "Time taken by DSATURScheduling for AdjList: " << duration << " ms" << endl;
    cout << "/*********************************************************/" << endl;

    cout << "/**************************** >DSATURScheduling ****************************" << endl;
    cout << "************************************ ADJMATRIX *************************************** " << endl;
    start = chrono::high_resolution_clock::now();
    G3->DSATURScheduling(numSubjectsInput, subjects);
    end = chrono::high_resolution_clock::now();
    duration = chrono::duration_cast<chrono::milliseconds>(end - start).count();
    cout << "Time taken by DSATURScheduling for AdjMatrix: " << duration << " ms" << endl;
    cout << "/*********************************************************/" << endl;
